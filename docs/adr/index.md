...
| ADR-002 | Auth, session, and truthful access denial | Proposed | Sign-in, session continuity, expiry, denial UX | [ADR-002](ADR-002-auth-session-and-truthful-access-denial.md) | 2026-04-08 |
...
| ADR-004 | Dashboard, reporting, and export responsibility | Proposed | Reporting, summary rendering, PDF/Excel exports | [ADR-004](ADR-004-dashboard-reporting-and-export-responsibility.md) | 2026-04-08 |
| ADR-005 | Service and API integration consistency boundary | Proposed | Service layer expectations and page/service boundary | [ADR-005](ADR-005-service-and-api-integration-consistency-boundary.md) | 2026-04-08 |

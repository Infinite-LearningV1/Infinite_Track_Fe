...
import { reportGenerator } from "../../src/js/utils/reportGenerator.js";
...
test("report generator builds PDF metadata rows from /summary/reports report/export period totals", () => {
  ...
  assert.deepEqual(rows, [
    ...
    [
      "Provenance",
      "Client-generated from /summary/reports using the selected report/export period. Missing backend fields remain Unavailable.",
    ],
  ]);
});

...
| ADR-006 | Env, build, and deploy runtime truth               | Proposed | Runtime assumptions, env truth, deployment evidence                | [ADR-006](ADR-006-env-build-and-deploy-runtime-truth.md)                | 2026-08-21   |
...
| ADR-010 | Release artifact and version governance            | Proposed | Versioning, tag, ZIP, provenance, publication, immutability        | [ADR-010](ADR-010-release-artifact-and-version-governance.md)           | 2026-08-22   |
